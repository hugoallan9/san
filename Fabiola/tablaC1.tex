...
\INEchaptercarta{Proyecciones de población (Dimensión 1)}
%%%cuadro 1
...
\begin{center}\fontsize{3.8mm}{1.8em}\selectfont 
	\begin{tabular}{lS[table-format=3]S[table-format=3]S[table-format=3]S[table-format=3]}
		
		\multicolumn{5}{l}{\Bold\color{color1!80!black}{\parbox{13cm}{Cuadro \theCuadro $\,-$  Necesidades Básicas Insatisfechas de los hogares rurales en  vivienda, hacinamiento, agua y saneamiento; según departamento. }}}\\
