\INEchaptercarta[Acceso a los alimentos (Dimensión 2)]{Acceso a los alimentos\\ (Dimensión 2)}{}

\addtocounter{Cuadro}{1}
\hoja{
	{\Bold\Large 3.1 Nivel de ingreso}\\
...
\begin{center}
	...
	\begin{tabular}{m{2.5cm}x{2.5cm}x{2.5cm}x{2.5cm}}
		\hline &&&\\[-0.56cm]  
		\multicolumn{1}{r}{ } &	\multicolumn{3}{c}{\Bold{Actividad económica}}\\[-0.1cm]\cline{2-4}
		 &&&\\[-0.56cm] 
...
\rowcolor{color1!40!white} \multicolumn{4}{c}{\Bold{Salario diario	}} 	\\[-0.05cm]
	...
	\rowcolor{color1!5!white}\multicolumn{1}{c}{	2015	} &	Q.  78.72	&	Q.  78.72	&	Q72.36	\\[-0.05cm]
	\rowcolor{color1!40!white} \multicolumn{4}{c}{\Bold{Salario mensual	}} 	\\[-0.05cm]
		...
		\rowcolor{color1!5!white}\multicolumn{1}{c}{	2015	} &	 2,394.4 	&	 2,394.4 	&	Q2,200.95	\\[-0.05cm]
		\rowcolor{color1!40!white} \multicolumn{4}{c}{\Bold{Salario total	}} \\	[-0.05cm]
...
\rowcolor{color1!5!white}\multicolumn{1}{c}{	2015	} &	 2,644.4 	&	 2,644.4 	&	Q2,450.95	\\[-0.05cm]\hline
\rowcolor{color1!40!white} \multicolumn{4}{c}{\Bold{Acuerdo Gubernativo	}} 	\\[-0.05cm]
...
\rowcolor{color1!5!white}\multicolumn{1}{c}{	2015	} & \multicolumn{3}{c}{	No. 470-2014	}\\\hline
		&&&\\[-0.56cm]
		\multicolumn{4}{l}{\footnotesize Fuente: Mintrab, Observatorio Laboral. Nota: Bonificación incentivo de Q. 250 según decreto No. 37-2001.}\\[-.15cm]	
...
%\begin{center}
%	\begin{spacing}{1.2}
%		\begin{tabular}{m{2.5cm}rx{2cm}r}
%			 &&&\\[-0.56cm] \hline
...
\begin{center}\fontsize{3.3mm}{1.75em}
	\begin{spacing}{1.2}
		\begin{tabular}{p{2.5cm}x{2.3cm}x{2.3cm}x{2.3cm}x{2.3cm}x{2.3cm}}
			...
			\hline
			&&&&&\\[-0.46cm]
			\multicolumn{6}{l}{\footnotesize Fuente: Instituto Guatemalteco de Seguridad Social.}\\
			%				\multicolumn{4}{l}{\footnotesize Nota: bonificación incentivo de Q. 250 según decreto No. 37-2001.}\\	
		\end{tabular}\addtocounter{Cuadro}{1}
	\end{spacing}
\end{center}
