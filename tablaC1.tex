...
\INEchaptercarta[Proyecciones de población (Dimensión 1)]{Proyecciones de población\\ (Dimensión 1)}{}
%%%cuadro 1
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%111
\hoja{
	\begin{center}\fontsize{2.6mm}{1.19em}\selectfont \setlength{\arrayrulewidth}{0.7pt}
		$\!$\begin{tabular}{lrrrrrrrr}
			\multicolumn{9}{l}{$\ $}\\[0.15cm]
...
\begin{center}\fontsize{3.8mm}{1.65em}\selectfont 
	\begin{tabular}{p{4cm}S[table-format=3]S[table-format=3]S[table-format=3]S[table-format=3]}
		...
		\multicolumn{1}{x{4cm}}{\Bold{Departamento}} & \multicolumn{1}{x{2.4cm}}{\Bold{Vivienda}} & \multicolumn{1}{x{2.4cm}}{\Bold{Hacinamiento}} & \multicolumn{1}{x{2.4cm}}{\Bold{Agua}} & \multicolumn{1}{x{2.4cm}}{\Bold{Saneamiento}} \\[0.05cm]
		\hline\color{black}
		&&&&\\[-0.8cm]
