...
\hoja{
	\begin{center}\fontsize{3.3mm}{1.45em}\selectfont \setlength{\arrayrulewidth}{0.7pt}
		$\!$\begin{tabular}{lrrrrrrrr}
			...
			\multicolumn{9}{l}{\normalsize (Personas)}
			\\[0.4cm]
%			\multicolumn{1}{l}{\multirow{3}[0]{*}{\Bold{\raisebox{-0.6cm}{ dfadljfoajfoa}}}} & \multicolumn{8}{c}{\Bold{Dominio de estudio}} \\\cline{2-9}
			\multicolumn{1}{l}{$\ $} &  \multicolumn{8}{c}{$\ $} \\[-0.28cm]
%			\multicolumn{1}{c}{$\ $} & \multicolumn{2}{c}{\Bold{Total nacional}} & \multicolumn{2}{c}{\Bold{Metropolitano}} & \multicolumn{2}{c}{\Bold{Resto urbano}} & \multicolumn{2}{c}{\Bold{Rural nacional}} \\
%			\multicolumn{1}{c}{} &  \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} & \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} & \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} & \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} \\\hline
	\multicolumn{1}{l}{\multirow{3}[0]{*}{\Bold{\raisebox{-0.6cm}{ }}}} & \multicolumn{8}{c}{\Bold{Año}} \\\cline{2-9}
				\multicolumn{1}{l}{$\ $} &  \multicolumn{8}{c}{$\ $} \\[-0.28cm]
%			\multicolumn{1}{l}{$\ $} &  \multicolumn{8}{c}{$\ $} \\[-1cm]
%&&&&&&&& \\\cline{2-9}
...
%			\multicolumn{9}{l}{\Bold{Sexo}} \\
%			\multicolumn{1}{l}{Hombre} & 3,859,890 & 64.5  & 714,193 & 57.5  & 1,180,165 & 59.7  & 1,965,532 & 71.0 \\
%			\multicolumn{1}{l}{Mujer} & 2,128,285 & 35.5  & 528,209 & 42.5  & 798,178 & 40.3  & 801,898 & 29.0 \\
%			\rowcolor{color1!10!white}     \multicolumn{9}{l}{\Bold{Grupos de edad}} \\
%			\rowcolor{color1!10!white}     \multicolumn{1}{l}{15 - 24} & 1,669,133 & 27.9  & 263,453 & 21.2  & 470,787 & 23.8  & 934,893 & 33.8 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{25 y más} & 4,319,042 & 72.1  & 978,949 & 78.8  & 1,507,556 & 76.2  & 1,832,537 & 66.2 \\
%			\multicolumn{9}{l}{\Bold{Grupo étnico}} \\
%			\multicolumn{1}{l}{Indígena} & 2,006,510 & 33.5  & 122,014 & 9.8   & 571,203 & 28.9  & 1,313,293 & 47.5 \\
%			\multicolumn{1}{l}{No indígena} & 3,981,665 & 66.5  & 1,120,388 & 90.2  & 1,407,140 & 71.1  & 1,454,137 & 52.5 \\
%			\rowcolor{color1!10!white}      \multicolumn{9}{l}{\Bold{Posición en el hogar}} \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Jefe(a) del hogar} & 2,835,400 & 47.3  & 584,625 & 47.1  & 913,546 & 46.2  & 1,337,229 & 48.3 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Esposo(a) o compañero(a)} & 891,207 & 14.9  & 235,830 & 19.0  & 323,802 & 16.4  & 331,575 & 12.0 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Hijo(a)} & 1,799,557 & 30.1  & 319,709 & 25.7  & 558,677 & 28.2  & 921,171 & 33.3 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Otros parientes y no parientes} & 462,011 & 7.7   & 102,238 & 8.2   & 182,318 & 9.2   & 177,455 & 6.4 \\
%			\multicolumn{9}{l}{\Bold{Estado conyugal}} \\
%			\multicolumn{1}{l}{Soltero(a)} & 1,678,527 & 28.1  & 344,723 & 27.9  & 540,278 & 27.3  & 793,526 & 28.7 \\
%			\multicolumn{1}{l}{Casado(a) o unido(a)} & 3,708,465 & 62.0  & 744,170 & 60.2  & 1,205,769 & 61.0  & 1,758,526 & 63.5 \\
%			\multicolumn{1}{l}{Viudo(a), separado(a), divorciado(a)} & 592,997 & 9.9   & 146,465 & 11.9  & 231,154 & 11.7  & 215,378 & 7.8 \\
%			\rowcolor{color1!10!white}      \multicolumn{9}{l}{\Bold{Jornada laboral}} \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Menos de 20 horas a la semana} & 652,993 & 10.9  & 87,810 & 7.1   & 229,711 & 11.6  & 335,472 & 12.1 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Entre 20 y 40 horas a la semana} & 2,442,057 & 40.8  & 437,793 & 35.3  & 819,106 & 41.4  & 1,185,158 & 42.8 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Entre 41 y 48 horas a la semana} & 1,639,062 & 27.4  & 328,737 & 26.5  & 523,428 & 26.5  & 786,897 & 28.4 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Más de 48 horas a la semana} & 1,252,860 & 20.9  & 387,160 & 31.2  & 406,098 & 20.5  & 459,602 & 16.6 \\
%			\multicolumn{9}{l}{\Bold{Afiliación al IGSS}} \\
%			\multicolumn{1}{l}{Asegurado} & 1,363,207 & 22.8  & 580,974 & 46.8  & 484,549 & 24.5  & 297,684 & 10.8 \\
%			\multicolumn{1}{l}{No asegurado} & 4,621,091 & 77.2  & 660,966 & 53.2  & 1,492,846 & 75.5  & 2,467,279 & 89.2 \\
%			\rowcolor{color1!10!white}      \multicolumn{9}{l}{\Bold{Sector económico}} \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Informal} & 4,151,127 & 69.3  & 545,517 & 43.9  & 1,252,539 & 63.3  & 2,353,071 & 85.0 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Formal} & 1,837,048 & 30.7  & 696,885 & 56.1  & 725,804 & 36.7  & 414,359 & 15.0 \\
%			\multicolumn{9}{l}{\Bold{Nivel educativo}} \\
%			\multicolumn{1}{l}{Ninguno} & 1,029,945 & 17.2  & 92,775 & 7.5   & 216,831 & 11.0  & 720,339 & 26.0 \\
%			\multicolumn{1}{l}{Primaria incompleta} & 1,402,866 & 23.4  & 183,703 & 14.8  & 326,589 & 16.5  & 892,574 & 32.3 \\
%			\multicolumn{1}{l}{Primaria completa} & 1,151,039 & 19.2  & 216,252 & 17.4  & 328,742 & 16.6  & 606,045 & 21.9 \\
%			\multicolumn{1}{l}{Diversificado incompleto} & 1,326,814 & 22.2  & 383,079 & 30.9  & 536,625 & 27.1  & 407,110 & 14.7 \\
%			\multicolumn{1}{l}{Diversificado completo} & 550,416 & 9.2   & 163,733 & 13.2  & 275,273 & 13.9  & 111,410 & 4.0 \\
%			\multicolumn{1}{l}{Superior incompleto} & 308,952 & 5.2   & 112,713 & 9.1   & 176,551 & 8.9   & 19,688 & 0.7 \\
%			\multicolumn{1}{l}{Superior completo} & 215,167 & 3.6   & 88,888 & 7.2   & 116,015 & 5.9   & 10,264 & 0.4 \\
%			\rowcolor{color1!10!white}      \multicolumn{9}{l}{\Bold{Contrato de los asalariados}} \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{No tiene} & 2,131,724 & 63.3  & 392,566 & 44.0  & 674,152 & 57.7  & 1,065,006 & 81.4 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Por tiempo indefinido} & 1,037,726 & 30.8  & 452,074 & 50.7  & 389,487 & 33.4  & 196,165 & 15.0 \\
%			\rowcolor{color1!10!white}      \multicolumn{1}{l}{Temporal o término fijo} & 198,773 & 5.9   & 47,471 & 5.3   & 103,974 & 8.9   & 47,328 & 3.6 \\
			\hline
			&&&&&&&&\\[-0.28cm]
...
\hoja{
	\begin{center}\fontsize{3.6mm}{1.45em}\selectfont \setlength{\arrayrulewidth}{0.7pt}
		$\!$\begin{tabular}{lrrrrrrrr}
			...
			\\[0.4cm]
			%			\multicolumn{1}{l}{\multirow{3}[0]{*}{\Bold{\raisebox{-0.6cm}{ dfadljfoajfoa}}}} & \multicolumn{1}{c}{\Bold{Dominio de estudio}} \\\cline{2-9}
			\multicolumn{1}{l}{$\ $} &  \multicolumn{8}{c}{$\ $} \\[-0.28cm]
			%			\multicolumn{1}{c}{$\ $} & \multicolumn{2}{c}{\Bold{Total nacional}} & \multicolumn{2}{c}{\Bold{Metropolitano}} & \multicolumn{2}{c}{\Bold{Resto urbano}} & \multicolumn{2}{c}{\Bold{Rural nacional}} \\
			%			\multicolumn{1}{c}{} &  \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} & \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} & \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} & \multicolumn{1}{c}{\Bold{N}} & \multicolumn{1}{c}{\Bold{\%}} \\\hline
	\multicolumn{1}{l}{\multirow{3}[0]{*}{\Bold{\raisebox{-0.6cm}{ }}}} & \multicolumn{8}{c}{\Bold{Año}} \\\cline{2-9}
...
\hoja{
	\begin{center}\fontsize{3.6mm}{1.19em}\selectfont \setlength{\arrayrulewidth}{0.7pt}
		$\!$\begin{tabular}{lrrrrrrrr}
			\multicolumn{9}{l}{$\ $}\\[0.15cm]
			\multicolumn{9}{l}{\Bold\color{color1!80!black}{\normalsize Cuadro \theCuadro $\,-$ Densidad poblacional por departamento y por año.}}\\
			\multicolumn{9}{l}{\normalsize (Personas por kilómetro cuadrado)}
...
\hoja{
{\Bold\color{color1!80!black}{Cuadro \theCuadro $\,-$   Pirámide poblacional. Año 2015.}}\\
\textcolor{white}{......} (Personas)\\
\begin{center}
%	$\ $\\[-7cm]
	\begin{tabular}{lrr}
...
\begin{center}
	\begin{tabular}{lS[table-format=8]S[table-format=8]S[table-format=8]S[table-format=8]}
		...
		\multicolumn{5}{l}{\Bold\color{color1!80!black}{Cuadro \theCuadro $\,-$  Variables del mercado de trabajo por dominios de estudio, población total}}\\
		\multicolumn{5}{l}{(Población de 15 o más años de edad)}
		\\[0.4cm]
		\hline\rowcolor{color1!40!white} &&&&\\[-0.36cm] \rowcolor{color1!40!white}
		\multicolumn{1}{x{2.4cm}}{\Bold{Departamento}} & \multicolumn{1}{x{2.4cm}}{\Bold{Vivienda}} & \multicolumn{1}{x{2.4cm}}{\Bold{Hacinamiento}} & \multicolumn{1}{x{2.4cm}}{\Bold{Agua}} & \multicolumn{1}{x{2.4cm}}{\Bold{Saneamiento}} \\[0.05cm]
		\hline\color{black}
		&&&&\\[-0.35cm]
		...
		\hline
		&&&&\\[-0.36cm]
		\multicolumn{5}{l}{\footnotesize Fuente: ENEI 1-2014}
	\end{tabular}\\[1.8cm] \addtocounter{Cuadro}{1}
\end{center}
...
\begin{center}
	\begin{tabular}{lS[table-format=2]S[table-format=2]S[table-format=2]S[table-format=2]}
		...
		\\[0.4cm]
		\hline  &&&&\\[-0.36cm]
		& 		\multicolumn{3}{c}{\Bold{Pobreza}}&	\\[.1cm]\cline{2-4}
		\multicolumn{1}{x{2.4cm}}{\Bold{\raisebox{.2cm}{Departamento}}} & \multicolumn{1}{x{2.4cm}}{\Bold{Total}} & \multicolumn{1}{x{2.4cm}}{\multirow{3}[0]{*}{\Bold{\raisebox{3.5cm}{Extrema}}}} & \multicolumn{1}{x{2.4cm}}{\Bold{No extrema}}& \multicolumn{1}{x{2.4cm}}{\raisebox{.2cm}{\Bold{No pobreza}}} \\[0.05cm]
		\hline
